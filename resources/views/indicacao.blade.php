                        ...
                        <ul class="nav side-menu">
                            <li class="">
                                ...
                                <ul class="nav child_menu" style="display: none;">
                                    <li><a href="/coordenador">Área do Orientador</a></li>
        ...
        <div class="right_col" role="main" style="min-height: 513px;">
            ...
            <div class="row">
                <div style='width: 100%;height: auto;padding: 50px;padding-top: 10px;' class="col-md-8 col-sm-8 col-xs-12">
                    <h1 style="text-align: center;">Indicação de Orientador</h1>
                    <h2 style="text-align: center;margin-top: 50px">1ª Opção de Orientador</h2>
                    ...
                    <h2 style="text-align: center;margin-top: 10px">2ª Opção de Orientador</h2>
                    <select class="form-control" style="    width: 300px;text-align: center;margin-left: calc(50% - 150px);border-radius: 5px 5px 0 0;">
                        <option>Professor 1</option>
                        <option>Professor 2</option>
                        <option>Professor 3</option>
                    ...
                    <h2 style="text-align: center;margin-top: 10px">3ª Opção de Orientador</h2>
                    <select class="form-control" style="    width: 300px;text-align: center;margin-left: calc(50% - 150px);border-radius: 5px 5px 0 0;">
                        <option>Professor 1</option>
                        <option>Professor 2</option>
                        <option>Professor 3</option>
                    ...
                    <h2 style="text-align: center;margin-top: 10px">4ª Opção de Orientador</h2>
                    <select class="form-control" style="    width: 300px;text-align: center;margin-left: calc(50% - 150px);border-radius: 5px 5px 0 0;">
                        <option>Professor 1</option>
                        <option>Professor 2</option>
                        <option>Professor 3</option>
                    ...
                    <div class="btn-group btn-group-justified" role="group" aria-label="..." style="width: 300px;left: calc(50% - 150px);margin-top: 15px;">
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-primary">Indicar</button>
                        </div>
                    </div>
                </div>
            </div>
