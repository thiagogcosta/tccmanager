        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/" class="site_title"><i class="fa fa-graduation-cap"></i> <span>Aluno</span></a>
                </div>
                <div class="clearfix"></div>
                <!-- menu profile quick info -->
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="http://www.univem.edu.br/imgs/thiago_photo.jpeg" alt="..." class="img-circle profile_img">
                    </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="http://www.univem.edu.br/imgs/thiago_photo.jpeg" alt="">Thiago Costa
        ...
        <div class="right_col" role="main" style="min-height: 513px;">
            ...
            <div class="row">
                <div style='width: 100%;height: auto;padding: 50px;padding-top: 10px;' class="col-md-8 col-sm-8 col-xs-12">
                    <h1 style="text-align: center;">Área do Aluno</h1>
                    <div class="btn-group btn-group-justified" role="group" aria-label="..." style="width: 300px;left: calc(50% - 150px);margin-top: 15px;">
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-primary">Indicar Orientador</button>
                        </div>
                    </div>
                    <div class="btn-group btn-group-justified" role="group" aria-label="..." style="width: 300px;left: calc(50% - 150px);margin-top: 15px;">
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-primary">Cadastro de Resumo</button>
                        </div>
                    </div>
                    <div class="btn-group btn-group-justified" role="group" aria-label="..." style="width: 300px;left: calc(50% - 150px);margin-top: 15px;">
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-primary">Cadastro de Pré-Projeto</button>
                        </div>
                    </div>
                    <div class="btn-group btn-group-justified" role="group" aria-label="..." style="width: 300px;left: calc(50% - 150px);margin-top: 15px;">
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-primary">Envio de Arquivos</button>
                        </div>
                    </div>
