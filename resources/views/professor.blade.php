        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/" class="site_title"><i class="fa fa-graduation-cap"></i> <span>Professor</span></a>
                </div>
                <div class="clearfix"></div>
                <!-- menu profile quick info -->
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="http://www.fatecgarca.edu.br/fotos/prof/navarro.jpg" alt="..." class="img-circle profile_img">
                    </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="http://www.fatecgarca.edu.br/fotos/prof/navarro.jpg" alt="">Fábio Navarro
        ...
        <div class="right_col" role="main" style="min-height: 513px;">
            ...
            <div class="row">
                <div style='width: 100%;height: auto;padding: 50px;padding-top: 10px;' class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <h2 style="text-align: center;margin-top: 20px">Selecione o Orientador</h2>
